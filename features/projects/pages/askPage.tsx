...
export default function AskPage() {
  return (
    <div className="text-center">
      ...
      <div className="flex py-[20px] w-[50%] sp:w-[90%] m-auto border-b-[1px] border-[#DDDDDD] sp:mt-[50px] mt-[90px]">
        <span className="w-[30%] flex justify-end  mt-[7px] mr-[67px]">
          <span>お名前</span>
          <span className="ml-[10px] text-[#EE5736] text-[11px]">必須</span>
        </span>
        <Input inputClassName="max-w-[250px] grow border-[#D3D3D3]" />
      </div>
      <div className="flex py-[20px] w-[50%] sp:w-[90%] m-auto border-b-[1px] border-[#DDDDDD]">
        <span className="w-[30%] flex justify-end mr-[67px]">
          <span>メールアドレス</span>
          <span className="ml-[10px] text-[#EE5736] text-[11px]">必須</span>
        </span>
        <Input inputClassName="max-w-[250px] grow border-[#D3D3D3]" />
      ...
      <div className="flex py-[20px] w-[50%] sp:w-[90%] m-auto border-b-[1px] border-[#DDDDDD]">
        ...
        <input className="max-w-[250px] grow border border-[#D3D3D3] h-[33px]"></input>
      </div>
      <div className="flex py-[20px] w-[50%] sp:w-[90%] m-auto border-b-[1px] border-[#DDDDDD]">
        <span className="w-[30%] flex justify-end  mt-[7px] mr-[67px]">
          <span>お問い合わせ内容</span>
      ...
      <div className="flex py-[20px] w-[50%] sp:w-[90%] m-auto border-b-[1px] border-[#DDDDDD]">
        ...
        <div className="text-left max-w-[250px] grow">
          <Input inputClassName="w-full border-[#D3D3D3]" />
